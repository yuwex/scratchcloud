...
class CloudClient:
    ...
    ### COMMANDS (Implement Future Version)
    # def command(self, func):
    #     f_name = func.__name__
    #     c_name = f'_command_{f_name}'

    #     # @static typing
    #     def wrap(*args, **kwargs):
    #         return func(*args, **kwargs)
        
    #     if c_name in self.commands:
    #         raise TypeError(f'Command function with name {f_name} already exists.')
        
    #     self.commands.append(f_name)
    #     setattr(self, c_name, func)

    #     return wrap
        
    # def static_typing(self, func):
    #     # do later
    #     return
    #     def wrap(*args, **kwargs):
    #         print(inspect.getargspec(func))
    #         print(locals())
    #         annotated_types = list(func.__annotations__.values())
    #         print(func.__annotations__)

    #         # for i, arg in enumerate(args):
                
    #         #     if type(arg) is not annotated_types[i]:
    #         #         raise TypeError(f'Expected argument at index {i} to be type {annotated_types[i]}')
            
    #         # annotated_types = annotated_types[len(args):]
    #         # for i, kwarg in enumerate(kwargs):
    #         #     if type(kwarg) is not annotated_types[i]:
    #         #         raise TypeError(f'Expected keyword argument at index {i} to be type {annotated_types[i]}')
